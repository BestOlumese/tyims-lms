...
export default function HomeCourses() {
  const { data, isLoading } = useQuery(
    orpc.getPublicCourses.queryOptions({
        ...
        <div className="row ss-1">
          <div className="col-12">
            ...
            <Swiper
              ...
              pagination={{ el: ".spc1", clickable: true }}
              breakpoints={{
              ...
              navigation={{ clickable: true, nextEl: ".snbn1", prevEl: ".snbp1" }}
              spaceBetween={25}
            >
              {courses.map((course) => (
                  ...
                  >
                    <div className="features image-wrap">
                      {course.thumbnailUrl ? (
                        ...
                        >
                          <i className="flaticon-play fs-30" />
                        </div>
                      )}
                    </div>
                    <div className="content" style={{ flex: 1, display: "flex", flexDirection: "column" }}>
                      ...
                      <div className="ratings pb-30">
                        ...
                        <i className="icon-star-1" />
                        {STAR_SVG}
                        <div className="total">({course.reviewCount})</div>
                      </div>
                      ...
                      <div className="bottom" style={{ marginTop: "auto" }}>
                        <div className="h6 price fw-5">{formatPrice(course.price)}</div>
