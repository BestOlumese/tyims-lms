"use client";
import { courses } from "@/upskill/data/courese";
...
import { useContextElement } from "@/upskill/context/Context";
const categories = [
  "Graphics & Design",
  "Digital Marketing",
  "Video & Animation",
                  ...
                  >
                    {filtered.map((elm, i) => (
                      <SwiperSlide key={i} className="swiper-slide">
                        <div className="course-item style-3 has-bg hover-img">
                    ...
                    <div className="swiper-pagination pagination-slider pagination-courses1 spd8" />
                  </Swiper>
