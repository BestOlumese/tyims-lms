...
import { menuItems, socialLinks } from "@/upskill/data/footerLinks";
              ...
              <div className="col-12">
                <div className="footer-body-wrap flex justify-between">
                  ...
                  >
                    ...
                    <p>
                      2000+ Our students are subscribe Around the World. Donâ€™t
            ...
            <div className="row">
              <div className="col-12">
                <div className="footer-bottom-wrap flex justify-center items-center">
                  <p>Â©&nbsp;2024&nbsp;UpSkill. All Rights Reserved</p>
                </div>
              </div>
            </div>
          </div>
