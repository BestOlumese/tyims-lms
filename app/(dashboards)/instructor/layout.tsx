    ...
    <>
      ...
      <div className="flex items-center gap-3 px-6 h-16 border-b border-gray-100">
        ...
        <span className="text-[15px] font-bold tracking-tight text-gray-900">
          LMS <span className="text-indigo-600">Instructor</span>
        </span>
      </div>
      ...
      <nav className="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto">
        ...
        <div className="pt-6 pb-2 px-4">
           ...
           <Link
            ...
            onClick={() => setSidebarOpen(false)}
            className="flex items-center gap-3 px-4 py-3 rounded-xl text-[13px] font-bold bg-indigo-600 text-white hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-100 group"
           >
              <PlusCircle size={18} className="text-white group-hover:rotate-90 transition-transform duration-500" />
              Create Course
           </Link>
        </div>
      </nav>
      ...
      <div className="p-6 border-t border-gray-50">
        <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
          <p className="text-[12px] font-bold text-gray-900">Instructor Help</p>
          <p className="text-[11px] text-gray-500 mt-1">Need help managing courses? Contact our support team.</p>
        </div>
      </div>
    </>
  );
